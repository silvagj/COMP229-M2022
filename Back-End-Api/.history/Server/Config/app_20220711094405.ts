...
//define JWT aliases
let JWRStrategy = passportJWT.Strategy;
...
//setup JWT strategy
let strategy = new JWRStrategy(jwtOptions, function(jwt_payload, done )
{
 User.findById
})
// use routes
  
app.use('/api', clientListRouter);  //identifying the routes as api endpoints
